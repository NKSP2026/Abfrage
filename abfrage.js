...
const injuryMapRegions=[
  ...
  R("front_neck","Hals vorne",415,155,50,45,.5),
  R("front_chest","Brustkorb",330,178,220,150,9),
  R("front_abdomen","Bauch",365,328,150,92,6),
  R("front_pelvis","Becken / Hüfte",365,420,150,105,3),
  R("front_shoulder_r","Schulter rechts",275,178,72,82,.25),
  R("front_shoulder_l","Schulter links",533,178,72,82,.25),
  R("front_upperarm_r","Oberarm rechts",250,238,75,122,1.5),
  R("front_upperarm_l","Oberarm links",555,238,75,122,1.5),
  R("front_elbow_r","Ellenbogen rechts",238,350,72,55,.25),
  R("front_elbow_l","Ellenbogen links",590,350,72,55,.25),
  R("front_forearm_r","Unterarm rechts",165,350,100,145,1.75),
  R("front_forearm_l","Unterarm links",615,350,100,145,1.75),
  R("front_wrist_r","Handgelenk rechts",145,488,75,48,.25),
  R("front_wrist_l","Handgelenk links",660,488,75,48,.25),
  R("front_palm_r","Handfläche rechts",115,515,105,58,.5),
  R("front_palm_l","Handfläche links",685,515,105,58,.5),
  R("front_thigh_r","Oberschenkel rechts",365,505,75,240,4.5),
  R("front_thigh_l","Oberschenkel links",450,505,75,240,4.5),
  R("front_knee_r","Knie rechts",360,745,85,72,.25),
  R("front_knee_l","Knie links",445,745,85,72,.25),
  R("front_lowerleg_r","Schienbein / Unterschenkel rechts",365,817,75,250,4),
  R("front_lowerleg_l","Schienbein / Unterschenkel links",450,817,75,250,4),
  R("front_ankle_r","Sprunggelenk rechts",360,1062,80,38,.15),
  R("front_ankle_l","Sprunggelenk links",450,1062,80,38,.15),
  R("front_foot_r","Fuß rechts",330,1092,105,68,.5),
  R("front_foot_l","Fuß links",445,1092,105,68,.5),
  ...makeDigitRegionsPx("front_finger_r","Finger","rechts",118,535,98,42,0),
  ...makeDigitRegionsPx("front_finger_l","Finger","links",687,535,98,42,0),
  ...makeDigitRegionsPx("front_toe_r","Zehe","rechts",332,1110,100,38,0),
  ...makeDigitRegionsPx("front_toe_l","Zehe","links",448,1110,100,38,0),
  ...
  R("back_neck","Nacken",1065,155,50,45,.5),
  R("back_upperback","Oberer Rücken",985,178,210,150,9),
  R("back_lowerback","Unterer Rücken",1015,328,150,92,6),
  R("back_pelvis","Becken / Hüfte hinten",1010,420,155,105,3),
  R("back_shoulder_r","Schulter rechts hinten",940,178,72,82,.25),
  R("back_shoulder_l","Schulter links hinten",1178,178,72,82,.25),
  R("back_upperarm_r","Oberarm rechts hinten",910,238,75,122,1.5),
  R("back_upperarm_l","Oberarm links hinten",1200,238,75,122,1.5),
  R("back_elbow_r","Ellenbogen rechts hinten",895,350,72,55,.25),
  R("back_elbow_l","Ellenbogen links hinten",1218,350,72,55,.25),
  R("back_forearm_r","Unterarm rechts hinten",825,350,100,145,1.75),
  R("back_forearm_l","Unterarm links hinten",1270,350,100,145,1.75),
  R("back_wrist_r","Handgelenk rechts hinten",805,488,75,48,.25),
  R("back_wrist_l","Handgelenk links hinten",1320,488,75,48,.25),
  R("back_palm_r","Handfläche rechts hinten",775,515,105,58,.5),
  R("back_palm_l","Handfläche links hinten",1340,515,105,58,.5),
  R("back_thigh_r","Oberschenkel rechts hinten",1010,505,75,240,4.5),
  R("back_thigh_l","Oberschenkel links hinten",1100,505,75,240,4.5),
  R("back_knee_r","Knie rechts hinten",1005,745,85,72,.25),
  R("back_knee_l","Knie links hinten",1095,745,85,72,.25),
  R("back_lowerleg_r","Unterschenkel rechts hinten",1010,817,75,250,4),
  R("back_lowerleg_l","Unterschenkel links hinten",1095,817,75,250,4),
  R("back_ankle_r","Sprunggelenk rechts hinten",1005,1062,80,38,.15),
  R("back_ankle_l","Sprunggelenk links hinten",1090,1062,80,38,.15),
  R("back_foot_r","Fuß rechts hinten",975,1092,105,68,.5),
  R("back_foot_l","Fuß links hinten",1090,1092,105,68,.5),
  ...makeDigitRegionsPx("back_finger_r","Finger","rechts hinten",778,535,98,42,0),
  ...makeDigitRegionsPx("back_finger_l","Finger","links hinten",1342,535,98,42,0),
  ...makeDigitRegionsPx("back_toe_r","Zehe","rechts hinten",978,1110,100,38,0),
  ...makeDigitRegionsPx("back_toe_l","Zehe","links hinten",1092,1110,100,38,0)
];
